...
class ReportController extends Controller
{
    ...
    public function products(Request $request)
    {
        try {
            ...
            // Filter by company of authenticated user
            if ($request->user() && $request->user()->company_id) {
                $query->where('invoices.company_id', $request->user()->company_id);
            }
    ...
    public function monthlySales(Request $request)
    {
        try {
            ...
            $query = Invoice::where('status', 'Issued')
    ...
    /**
     * Get public sales report (temporary for debugging)
     */
    ...
    /**
     * Get public customers report (temporary for debugging)
     */
    public function getPublicCustomers(Request $request)
    {
        try {
            $request->validate([
                'start_date' => 'nullable|date',
            ...
            // Filter customers by company if provided
            if ($request->has('company_id') && $request->company_id) {
                $query->where('company_id', $request->company_id);
            }
    ...
    /**
     * Get public products/services report (temporary for debugging)
     */
    ...
    /**
     * Get public monthly sales report (temporary for debugging)
     */
    public function getPublicMonthlySales(Request $request)
    {
        try {
            $request->validate([
                'year' => 'required|integer|min:2020|max:' . (date('Y') + 1),
